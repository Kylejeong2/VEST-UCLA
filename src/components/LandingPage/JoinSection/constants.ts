...
export const testimonials = [
  {
    testimony:
      "Gloriously Leading VEST's operations, creating websites, and ensuring our members get hands-on experience with VCs and startups.",
    person: "Kyle",
    role: "President",
  ...
  {
    testimony:
      "Managing club logistics and legal requirements to establish VEST as an official UCLA organization.",
    person: "Jake",
  ...
  {
    testimony:
      "Overseeing financial operations and maintaining our technical infrastructure.",
    person: "Sam",
